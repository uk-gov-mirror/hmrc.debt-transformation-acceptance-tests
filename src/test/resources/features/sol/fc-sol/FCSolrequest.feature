...
Feature: fc statement of liability multiple debts
  ...
  Scenario: 1. FC Sol request with Single debt ID's and single payments.
    Given fc sol request
      | customerUniqueRef | solRequestedDate |
      | NEHA1234          | 2021-05-13       |
  ...
  Scenario: 2. FC Sol request with invalid or empty original amount.
    Given fc sol request
      | customerUniqueRef | solRequestedDate |
      | NEHA1234          | 2021-05-13       |
    And the fc sol debt item has multiple debts
  ...
  Scenario: 3. Large Non Interest bearing debt with no payments.
    Given fc sol request
      | customerUniqueRef | solRequestedDate |
      | NEHA1234          | 2021-08-01       |
    And the fc sol debt item has multiple debts
