...
#      | 400        | Invalid JSON error from IFS | Field at path '/debtItems(0)/originalAmount' missing or invalid |
  ...
  Scenario: 1 debts, 1 Payment  Amount paid greater than original debt amount
    Given a debt item
  ...
  Scenario: 1 debt, 1 payment amount paid less than zero
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
      | 50             | 2019-12-16        | 2020-05-05          | 1525      | 1000     |
    And the debt item has payment history
  ...
  Scenario: 1 debt, 2 payment amounts with one less than zero
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
  ...
  Scenario: Original amount and payment amount less than zero
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
      | -50000         | 2019-12-16        | 2020-05-05          | 1525      | 1000     |
    And the debt item has payment history
  ...
  Scenario: Original amount less than zero
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
      | -50000         | 2019-12-16        | 2020-05-05          | 1525      | 1000     |
    And the debt item has no payment history
  ...
  Scenario: Original and payment amounts can be equal to zero
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
