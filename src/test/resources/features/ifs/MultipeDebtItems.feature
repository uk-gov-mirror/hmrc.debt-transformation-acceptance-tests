...
Feature: Multiple Debt Items
  ...
  Scenario: Non Interest Bearing. 1 Payment of 1 debt.
    Given a debt item
  ...
  Scenario: Interest Bearing. 2 Payments of 1 debt.
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans | interestBearing |
      | 500000         | 2018-12-16        | 2019-04-14          | 1525      | 1000     | true            |
    And the debt item has payment history
  ...
  Scenario: Interest Bearing. 2 debts. 1 debt with payment the second debt with no payment.
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans | interestBearing |
      | 500000         | 2018-12-16        | 2019-04-14          | 1525      | 1000     | true            |
    And the debt item has payment history
  ...
  Scenario: 1 debt, no payment interest requested to date is before the interest start date
    Given a debt item
  ...
  Scenario: 1 debt, no payment interest requested to date is same as interest start date
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
  ...
  Scenario: 1 debt, 1 payment interest requested to date is before the interest start date
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
      | 1000000        | 2023-03-03        | 2022-02-02          | 1525      | 1000     |
    And the debt item has payment history
  ...
  Scenario: 1 debt, non interest bearing, interest requested to date is before the interest start date, no dates are required
    Given a debt item
      | originalAmount | interestStartDate | interestRequestedTo | mainTrans | subTrans |
