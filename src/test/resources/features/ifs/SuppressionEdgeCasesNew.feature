...
Feature: Suppression - Edge cases
  ...
  Scenario: Suppression, interest rate change during suppression
    Given suppression configuration data is created
      | suppressionDateFrom | suppressionDateTo | suppressionReason | suppressionReasonDesc | suppressionChargeDescription | mainTrans | subTrans | postcode | checkPeriodEnd |
      | 2021-04-04          | 2021-05-04        | LEGISLATIVE       | COVID                 | SA-Suppression               | 1535      | 1000     | EC2M 2LS | true           |
    ...
    And a debt item
      ...
      | 500000         | 2021-02-01        | 2021-07-06          | 1535      | 1000     | EC2M 2LS | 2021-03-06 |
    ...
    Then the 1st debt summary will have calculation windows
      ...
      | 2021-03-01 | 2021-04-03 | 33           | 2.6          | 2021-04-03           |        |      |             |
