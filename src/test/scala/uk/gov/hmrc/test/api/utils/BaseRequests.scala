...
trait BaseRequests extends RandomValues with BaseUris {
  ...
  def createBearerToken(enrolments: Seq[String] = Seq(),
  ...
  def createLocalBearerToken(enrolments: Seq[String], userType: String , utr: String )={
    print("enrolments to create token :::::::::::::::::::::::::::::::::::::: "+enrolments)
    val json =
      Json.obj(
    ...
    val authBearerToken: String = authHeader._2.head.replace("Bearer ", "")
    authBearerToken
  ...
  def createQaBearerToken(scope :String):String = {
    ...
    val accessToken: StandaloneWSResponse = {  val json = Json.obj(
      ...
      "scope" -> scope)
      val accessTokenResponse = WsClient.post(s"$oauthUri/token",
